@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between site-pagination">
        <div class="flex justify-between flex-1 sm:hidden pagination-prev-next-area">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between pagination-prev-next-number-area">
            ...
            <div  class="pagination-links d-none">
